      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          <div className="relative flex justify-center animate-float">
            <div className="relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl overflow-hidden border border-cyan-500/20 shadow-2xl shadow-cyan-500/10 w-full max-w-md h-80 sm:h-96 group hover:border-cyan-500/50 transition-all">
              <img
                src={hero}
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-blue-600/20 group-hover:from-cyan-500/30 group-hover:to-blue-600/30 transition-all duration-500"></div>
            </div>

        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-slate-300 animate-slide-up" style={{ animationDelay: "200ms" }}>
              ...
              <div className="flex flex-wrap gap-4 animate-slide-up" style={{ animationDelay: "400ms" }}>
                ...
                <button
                  ...
                  className="group border border-cyan-500/30 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-500/10 transition-all duration-300 backdrop-blur-sm flex items-center space-x-2 cursor-pointer"
                >
            ...
            {/* RIGHT SIDE — VIDEO INSIDE SECTION */}
            <div className="relative animate-float" ref={videoRef}>
              <div className="relative z-10 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl p-8 border border-cyan-500/20 shadow-2xl shadow-cyan-500/10">
                  ...
                  {!isVideoOpen && (
                    ...
                    >
                      <img
                        ...
                        className="w-full h-full object-cover opacity-70 group-hover:opacity-90 transition duration-300"
                      />
                      <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/40 to-blue-600/40"></div>

                      <Play className="w-20 h-20 text-white absolute inset-0 m-auto drop-shadow-xl transition-transform group-hover:scale-110" />
                    </div>
                  )}

                  {/* AFTER CLICK — SHOW YOUTUBE */}
                  {isVideoOpen && (
                    <iframe
                ...
                <div className="mt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-cyan-400 font-semibold">+245%</span>
                  </div>

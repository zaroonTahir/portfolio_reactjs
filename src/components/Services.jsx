      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <FeaturedServiceRow
            ...
            features={[
              { title: "Web Applications", desc: "Custom solutions built with modern frameworks" },
              { title: "Mobile Apps", desc: "iOS, Android, and cross-platform development" },
              { title: "Enterprise Solutions", desc: "ERP, CRM, and SaaS applications" }
            ]}
          ...
          <FeaturedServiceRow
            ...
            features={[
              { title: "Business Process Automation", desc: "Streamline and automate workflows" },
              { title: "AI Chatbots", desc: "Intelligent bots for customer service" },
              { title: "Data Automation", desc: "Automated data processing and integration" }
            ]}
          ...
          <FeaturedServiceRow
            ...
            features={[
              { title: "SEO Optimization", desc: "On-page, technical, and local SEO" },
              { title: "Social Media Management", desc: "Content creation and community engagement" },
              { title: "Paid Advertisement", desc: "Google Ads and Meta advertising campaigns" }
            ]}

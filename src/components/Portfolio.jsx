  ...
  return (
    <section id="portfolio" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto ">
        ...
        {/* Portfolio Grid */}
        <div ref={ref} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
    ...
    >
      ...
      <div className="relative z-10 p-6 h-full flex flex-col justify-end">
        ...
        <div
          ...
          style={{
            transform: isHovered ? 'translateY(0) rotateZ(0deg)' : 'translateY(10px) rotateZ(-5deg)',
      ...
      <div
        ...
        style={{
          ...
          boxShadow: isHovered ? '0 0 30px rgba(34, 211, 238, 0.3) inset' : 'none'
        }}
      ></div>

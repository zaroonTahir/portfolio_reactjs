...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900/80 backdrop-blur-sm border-t border-slate-800 py-16 px-4 sm:px-6 lg:px-8 cursor-pointer">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6 animate-slide-up" style={{ animationDelay: '100ms' }}>
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              {[
                ...
                { name: "Creative & Media Production", slug: "media-production" },
                { name: "GHL Development & Integration", slug: "ghl-development" },
                { name: "Marketing Consultation & Strategies", slug: "marketing-consultation" },
              ].map((service, i) => (
                <li key={i}>
                  <button
          ...
          <div className="space-y-6 animate-slide-up" style={{ animationDelay: '200ms' }}>
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              <li>
                <button onClick={() => handlePageClick("/about")} className="hover:text-cyan-400 transition-colors duration-300 hover:translate-x-1 inline-block text-left group">
                  <span className="group-hover:underline">About Us</span>
                </button>
              </li>
              <li>
                <button onClick={handlePortfolioClick} className="hover:text-cyan-400 transition-colors duration-300 hover:translate-x-1 inline-block text-left group">
                  <span className="group-hover:underline">Portfolio</span>
                </button>
              </li>
              <li>
                <button onClick={() => handlePageClick("/contact")} className="hover:text-cyan-400 transition-colors duration-300 hover:translate-x-1 inline-block text-left group">
          ...
          <div className="space-y-6 animate-slide-up" style={{ animationDelay: '300ms' }}>
            ...
            <p className="text-slate-400 text-sm">Subscribe for digital tips and latest industry insights</p>
            <form className="flex gap-2">
              ...
              />
              <button type="submit" className="bg-gradient-to-r from-cyan-500 to-blue-600 px-4 py-3 rounded-lg hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 group">

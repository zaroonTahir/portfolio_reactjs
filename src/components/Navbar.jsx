    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            <img src={logo} alt="SMJ Solutions Logo" className="w-10 h-10 object-contain transform group-hover:scale-110 transition-transform" />
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              {isMenuOpen ? <X className="w-6 h-6 animate-rotate" /> : <Menu className="w-6 h-6" />}
            </button>
          </div>
        </div>
      </div>
